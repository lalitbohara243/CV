...
<head>
    ...
    <title>Lalit Resume - Profile HTML Page</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="mx-auto col-lg-5 col-md-5 col-10">
                <img src="{{asset('images/'.$per->image)}}" height="500px" width="500px" class="img-fluid" alt="">
                {{--<img src="{{asset('frontend/images/ben.jpg')}}" class="img-fluid" alt="Ben Resume HTML Template">--}}
            </div>
            @endforeach
            @foreach($personal as $per)
<!--                --><?php
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                @foreach($username as $user)
                <h3 class="mb-4">This is {{$user->username}} resume</h3>
                @endforeach
                ...
                <ul class="mt-4 mb-5 mb-lg-0 profile-list list-unstyled">
                    @foreach($username as $user)
                    <li><strong>Full Name :</strong> {{$user->username}} </li>
                    @endforeach
                    <li><strong>Date of Birth:</strong> {{$per->dob}}</li>

                    <li><strong>Website :</strong> {{$per->website}}</li>
            ...
            <div class="col-lg-5 mx-auto col-md-6 col-12">
                <img src="{{asset('frontend/images/true-agency.jpg')}}" class="about-image img-fluid" alt="Ben's Resume HTML Template">
            </div>
            ...
            <div class="col-12">
                ...
                <div class="owl-carousel owl-theme" id="testimonials-carousel">
                    ...
                    <div class="item">
                        <div class="testimonials-thumb d-flex">
                            <div class="testimonials-image">
                                <img src="{{asset('frontend/images/testimonials/testimonial-image02.jpg')}}" class="img-fluid" alt="testimonials image">
                            </div>
                    ...
                    <div class="item">
                        <div class="testimonials-thumb d-flex">
                            <div class="testimonials-image">
                                <img src="{{asset('frontend/images/testimonials/testimonial-image03.jpg')}}" class="img-fluid" alt="testimonials image">
                            </div>
...
<section class="contact section-padding pt-0" id="contact">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <form  method="post" action="" class="contact-form webform"  role="form">
            ...
            <div class="mx-auto col-lg-4 col-md-6 col-12">
                ...
                <ul class="social-links mt-2">
                    <li><a href="https://www.facebook.com/lalit.bohara.102" rel="noopener" class="fab fa-facebook"></a></li>
                ...
                <p class="copyright-text mt-5 pt-3">Copyright &copy; 2020 Lalit Bohara Resume Page</p>
